  ...
  return (
    <div className="bg-black  text-white min-h-screen p-8">
      <div className="items-center mb-8">
        ...
        <h1 className="text-5xl py-4 text-gray-200 text-left "><strong> Data Dashboard</strong></h1>
      </div>
      <div className="grid grid-cols-1  gap-12">
        <div className="bg-black/90 p-6 rounded-lg shadow-lg" style={{ height: '500px' }}>
